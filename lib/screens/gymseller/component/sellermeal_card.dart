...
class SellerMealCard extends StatefulWidget {
  SellerMealCard({super.key, required this.plandata});
  Map<String, dynamic> plandata;

  State<SellerMealCard> createState() => SellerMealCardState();
}

class SellerMealCardState extends State<SellerMealCard> {
              ...
              child: Padding(
                  ...
                  child: Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        print("pressed");
                        Navigator.pushNamed(context, SeemealPlan.routeName,
